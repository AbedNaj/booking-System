                    ...
                    <div class="flex items-center space-x-2">
                        <div class="relative">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-4 w-4 text-gray-400 absolute left-3 top-2.5" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-zinc-700">
                        @foreach ($bookings as $booking)
                            <tr class="hover:bg-gray-50 dark:hover:bg-zinc-700/30">
                                ...
                                <td class="px-6 py-4 text-gray-700 dark:text-gray-300">{{ $booking->employee->name }}
                                </td>
                                <td class="px-6 py-4">

                                    <span
                                        class="text-gray-700 dark:text-gray-300">{{ $booking->customer->name }}</span>
