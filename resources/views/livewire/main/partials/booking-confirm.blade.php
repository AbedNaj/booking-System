            ...
            <div class="bg-white rounded-2xl p-6 max-w-md w-full mx-4 relative">
                ...
                <div class="bg-gray-50 p-4 rounded-xl mb-6">
                    ...
                    <div class="flex justify-between mb-2">
                        ...
                        <span class="font-medium" x-text="confirmedDate"> </span>
                    </div>
                    <div class="flex justify-between mb-2">
                    ...
                    <div class="flex justify-between mb-2">
                        ...
                        <span class="font-medium" x-text="confirmedEmployeeName"> </span>
                    </div>
                    <div class="flex justify-between mb-2">
                ...
                <div class="flex gap-3">
                    ...
                    <button @click="$wire.bookingConfirm( confirmedEmployee , dateConfirmed , selectedTime , endTime)"
                        class="flex-1 py-3 px-4 hover:cursor-pointer bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition flex items-center justify-center font-medium">
